...
export default function Work({ data }) {
  return (
    <section id="work" className="py-20 animate-fadeIn">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {data.projects.map((project) => (
            ...
            >
              ...
              >
                View Project <ArrowRight className="w-5 h-5 transform group-hover:translate-x-1 transition-transform duration-300" />
              </a>
            </div>
          ))}
        </div>
